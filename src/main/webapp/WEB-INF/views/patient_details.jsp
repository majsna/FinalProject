	...
	<div class="row">
		<h4><b>PATIENT DATA</b></h4>
			<div class="col-sm-4">
				...
				<p>${patient.city}</p>
				<p>
					<b>Basic diagnosis:</b> <br>${patient.basicDiagnosis}
				</p>
				<br>
				<p>
...
<script type="text/javascript" src="<c:url value="/static/js/patient_details.js?newversion"/>"></script>
</body>
</html>